  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8 w-full max-w-6xl mx-auto">
        {/* Heading - Responsive */}
        <h1 
          className="font-bold mb-4 sm:mb-6 md:mb-8 mx-auto md:whitespace-nowrap"
          style={{
        ...
        <div className="mx-auto w-full" style={{ maxWidth: '578px' }}>
          ...
          >
            <span className="block">Join a mission-driven team where your skills create lasting impact on Africa's tech future. We're looking for passionate individuals who want to make a difference. </span>
