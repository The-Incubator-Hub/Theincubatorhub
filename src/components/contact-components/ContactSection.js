        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative">
            ...
            <p className="text-gray-500 text-sm mb-12 leading-relaxed">
              Seamless Communication, Global Impact. Seamless Communication, Global Impact. 
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-normal">info@golia.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-normal">+1-202-555-0138</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-gray-900 font-normal">901 N Pitt Str., Suite 170</p>
                  <p className="text-gray-900 font-normal">Alexandria, VA 22314, USA</p>
                </div>
              </div>
            </div>
